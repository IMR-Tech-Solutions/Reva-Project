...
>
  ...
  {/* Animated indicator pointing to India */}
  <div className="absolute top-[46%] left-[64%] w-3 h-3 bg-secondary rounded-full animate-ping opacity-70" /> 
  <div className="absolute top-[46%] left-[64%] w-2.5 h-2.5 bg-secondary rounded-full" />
</motion.div>
