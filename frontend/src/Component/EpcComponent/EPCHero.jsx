    ...
    <section className="relative overflow-hidden bg-white py-16 md:py-20 lg:py-24">
      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-16 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center z-10">
        ...
        >
          ...
          >
            Complete EPC Solutions <br />
            <span className="text-secondary">Concept to Commissioning</span>
          </motion.h1>
          ...
          >
            Reva delivers fully integrated EPC and EPCCM solutions for process
            industry projects — combining in-house engineering, procurement,
            manufacturing, site construction, and commissioning under one
            accountable team, from concept to operating plant.
          </motion.p>
        ...
        >
          ...
          >
            <img
              src="./epc.png"
              alt="Reva EPC Solutions – Engineering, Procurement, Construction & Commissioning"
