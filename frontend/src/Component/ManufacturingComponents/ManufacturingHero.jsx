      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-16 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center z-10">
        ...
        >
          ...
          >
            ...
            <span className="text-secondary">From Design to Execution-Ready</span>
          </motion.h1>
          ...
          >
            Reva develops comprehensive detailed engineering packages across
            process, piping, mechanical, civil, structural, electrical, and
            instrumentation disciplines — delivering constructible, code-compliant
            designs aligned with client performance, safety, and reliability
            expectations.
          </motion.p>
          ...
          >
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              transition={{ duration: 0.2 }}
              className="w-fit inline-flex items-center justify-center gap-2 border-2 border-primary text-primary font-semibold px-6 sm:px-8 py-3 sm:py-4 rounded-lg hover:bg-primary hover:text-white transition-all duration-300 text-sm sm:text-base"
            >
              View All Services
            </motion.a>
          </motion.div>
