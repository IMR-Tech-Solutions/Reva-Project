...
export const searchData = [
  ...
  {
    title: "Home",
    description: "Reva Process Technologies — India-based EPCC and EPCM solutions provider delivering end-to-end process plant projects from concept to commissioning.",
    url: "/",
    keywords: ["home", "reva", "epcc", "epcm", "process technologies", "engineering", "pune"]
  },
  {
    title: "About Us",
    description: "Learn about Reva Process Technologies — founded in 2014 by Mr. Kedar Chaudhari, headquartered in Pune, serving process industries across India and international markets.",
    url: "/about",
    keywords: ["about", "company", "kedar chaudhari", "founder", "ceo", "history", "pune", "baner", "reva"]
  },
  {
    title: "News",
    description: "Latest news, updates, and announcements from Reva Process Technologies.",
    url: "/news",
    keywords: ["news", "updates", "announcements", "press", "media"]
  },
  {
    title: "Career",
    description: "Join Reva Process Technologies — open positions in process, mechanical, piping, civil, electrical, instrumentation, and project management disciplines.",
    url: "/career",
    keywords: ["career", "jobs", "hiring", "employment", "opportunities", "process engineer", "piping", "mechanical"]
  },
  {
    title: "Contact Us",
    description: "Contact Reva Process Technologies at Trident Business Center, Baner, Pune for project enquiries, technical discussions, and RFQs.",
    url: "/contact",
    keywords: ["contact", "email", "phone", "address", "quote", "rfq", "inquiry", "pune", "baner"]
  },
...

  {
    ...
    description: "Reva Process Technologies privacy policy — how we collect, use, and protect your personal data.",
    url: "/privacy",
    keywords: ["privacy policy", "data protection", "personal data", "GDPR", "cookies"]
  },
  {
    title: "Terms & Conditions",
    description: "Terms and conditions governing use of the Reva Process Technologies website and services.",
    url: "/terms",
    keywords: ["terms", "conditions", "legal", "agreement", "usage policy"]
  },
  {
    title: "Cookie Policy",
    description: "How Reva Process Technologies uses cookies and manages your browsing preferences.",
    url: "/cookies",
    keywords: ["cookies", "cookie policy", "tracking", "preferences", "browser"]
  },
  {
    title: "Sitemap",
    description: "Full sitemap of the Reva Process Technologies website — navigate all pages, services, technologies, and products.",
    url: "/sitemap",
    keywords: ["sitemap", "navigation", "all pages", "structure", "directory"]
  }
];
